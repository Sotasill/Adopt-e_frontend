const ruTranslation = {
  ...
  registration: {
    ...
    errors: {
      ...
      usernameRepeating:
        "Имя пользователя не должно содержать повторяющиеся символы или буквы (например, AAA, A A A)",
      password:
        "Пароль должен быть не менее 8 символов и содержать хотя бы одну букву и одну цифру",
